...
mod tests {
    ...
    fn test_merging() {
        ...
        stat_a.merge(stat_b);
        assert_eq!(stat_a.app_ids[0].0, String::from("Debug"));
        assert_eq!(stat_a.app_ids[1].0, String::from("Error"));
        assert_eq!(stat_a.app_ids[2].0, String::from("Verbose"));
        assert_eq!(stat_a.app_ids[3].0, String::from("Warn"));
